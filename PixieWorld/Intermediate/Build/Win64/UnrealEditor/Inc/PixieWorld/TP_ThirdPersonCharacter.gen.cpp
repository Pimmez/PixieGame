...
#include "PixieWorld/TP_ThirdPerson/TP_ThirdPersonCharacter.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTP_ThirdPersonCharacter() {}
// Cross Module References
	PIXIEWORLD_API UClass* Z_Construct_UClass_ATP_ThirdPersonCharacter_NoRegister();
	PIXIEWORLD_API UClass* Z_Construct_UClass_ATP_ThirdPersonCharacter();
...
// End Cross Module References
	...
	template<> PIXIEWORLD_API UClass* StaticClass<ATP_ThirdPersonCharacter>()
	{
		return ATP_ThirdPersonCharacter::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ATP_ThirdPersonCharacter);
	struct Z_CompiledInDeferFile_FID_PixieWorld_Source_PixieWorld_TP_ThirdPerson_TP_ThirdPersonCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PixieWorld_Source_PixieWorld_TP_ThirdPerson_TP_ThirdPersonCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ATP_ThirdPersonCharacter, ATP_ThirdPersonCharacter::StaticClass, TEXT("ATP_ThirdPersonCharacter"), &Z_Registration_Info_UClass_ATP_ThirdPersonCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATP_ThirdPersonCharacter), 1416687765U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PixieWorld_Source_PixieWorld_TP_ThirdPerson_TP_ThirdPersonCharacter_h_801196202(TEXT("/Script/PixieWorld"),
		Z_CompiledInDeferFile_FID_PixieWorld_Source_PixieWorld_TP_ThirdPerson_TP_ThirdPersonCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_PixieWorld_Source_PixieWorld_TP_ThirdPerson_TP_ThirdPersonCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
